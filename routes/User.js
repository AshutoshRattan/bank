...
const { createAccount, login, createAlias, getAliases, forgotPasswordOTP, forgotPassword, changePassword} = require('../controllers/User')
...
router.post('/changePassword', passportJWTAuth, changePassword)
